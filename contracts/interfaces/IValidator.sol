...
interface IValidator {
    ...
    function jail(uint64 _jailedUntil, bool _tombstoned) external;
    ...
    function validateSignature(uint256 _votingPower, bool _signed, uint256 _signedBlockWindow, uint256 _minSignedPerWindow, uint256 _downtimeJailDuration) external;
