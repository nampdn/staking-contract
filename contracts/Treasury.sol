...
contract Treasury {
    ...
    uint256 constant public MIN_STAKE = 10000000000000000000000; // 10000 KAI
    ...
    function addProposal(uint256 value) public payable {
        require(msg.value >= MIN_STAKE, "Deposit must greater or than 10000 KAI");
        require(value <= address(this).balance, "Amount must smaller or equal treasury balance");
    ...
    function addVote(uint proposalId) public {
    ...
    function confirmProposal(uint proposalId) payable public {
        ...
        require(proposals[proposalId].deposit + proposals[proposalId].value >= address(this).balance, "Amount must smaller or equal treasury balance");
